...
class Connection {
  constructor(from) {
    ...
    this.MAX_TIMEOUT = 15000; // 15 second to reconnect
  ...
  async stop() {
    ...
    setStatus('closed'); // TODO: can we factor all UI code into a separate class?
  ...
  handleConnectionStateChangeEvent(event) {
    ...
    setStatus(this.peerConnection.connectionState);
  ...
  shareCamera.addEventListener('click', e => {
    ...
    navigator.mediaDevices.getUserMedia({ 
      ...
      cameraVideo.addEventListener('dblclick', function (e) {
        cameraVideo.classList.toggle('invert'); // TODO: check whether front or back
      });
